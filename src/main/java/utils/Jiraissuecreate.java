...
public class Jiraissuecreate {
    ...
    public static String createIssue(String jiraUrl, String username, String apiToken, String summary, String description) throws Exception {
    ...
    // 응답에서 이슈 키를 추출하는 메서드
    private static String extractIssueKeyFromResponse(String response) {
